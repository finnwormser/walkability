...
outputdir = Path.cwd()
outputdb = outputdir / 'walkability_data_with_counters_slurm.db'
...
def write_to_db(overwrite=False):
    ...
    for f in file_subset:
        ...
        print('Writing...')
        df.to_sql(name='tweet_sent_per_dayblock', con=engine, if_exists='append', index=True, chunksize=10_000)
